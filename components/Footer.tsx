...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-16 border-t border-slate-800 bg-slate-950/80 py-10 px-4 text-slate-400 text-xs">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h3 className="text-slate-200 font-semibold mb-2 uppercase tracking-wider text-xs">
        ...
        <div className="pt-6 border-t border-slate-900 flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-slate-400">
          <p>
